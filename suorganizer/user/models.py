...
class Profile(models.Model):
    #By default, the AUTH_USER_MODEL setting points to auth.User
...
class UserManager(BaseUserManager):
    # Let migrations system use the manager when interacting with User
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # informs Django which of our fields is to be used for logins and the like
