...
class AllowFuturePermissionMixin():
    # We can directly integrate the view_future_post
    # permission in the get_allow_future()
    # Instead of applying the permission to an entire Postlist, 
    # we’ve limited it to a subset of model instances.
...
#                self.request.GET.get(self.month_query_kwarg))
#        if month is None:
...
#            raise Http404(
#                "Future {} not available because {}.allow_future is False."
#                .format(
